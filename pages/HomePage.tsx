      ...
      <section className="relative h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl">
          ...
          <p className="text-xl md:text-2xl mb-10 text-gray-100 max-w-2xl mx-auto leading-relaxed">
            نحن ننسج ذكرياتك بأيدي خبيرة، رحلات استثنائية حول العالم صُممت
            خصيصاً لتناسب تطلعاتك.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => scrollToSection("trips")}
              className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white px-8 py-4 rounded-full text-lg font-bold transition-all shadow-xl shadow-orange-600/30 cursor-pointer"
            >
              تصفح الرحلات المتاحة
            </button>
            <button
              onClick={() => scrollToSection("history")}
              className="bg-white/10 hover:bg-white/20 text-white border border-white/30 backdrop-blur-md px-8 py-4 rounded-full text-lg font-bold transition-all cursor-pointer"
            >
              أرشيف رحلاتنا
            </button>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
            <div className="text-right">
              ...
              <p className="text-gray-600">
                احجز مكانك الآن في إحدى رحلاتنا المميزة حول العالم.
              </p>
            </div>
          </div>
          ...
          {loading ? (
            ...
            <div className="bg-gray-50 rounded-3xl p-12 text-center border-2 border-dashed border-gray-200">
              <p className="text-xl text-gray-400">
                لا توجد رحلات متاحة حالياً. تابعنا للمزيد قريباً!
              </p>
            </div>
          )}
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              نظرة سريعة على بعض من رحلاتنا السابقة واللحظات التي لا تُنسى التي
              شاركناها مع عملائنا.
            </p>
          </div>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              آراء بعض من عملائنا الكرام الذين وثقوا بنا لخلق ذكرياتهم السياحية.
            </p>
          </div>
